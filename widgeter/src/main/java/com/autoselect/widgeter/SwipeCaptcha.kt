...
@JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    interface OnCaptchaMatchCallback {
        fun matchSuccess(swipeCaptcha: SwipeCaptcha)
        fun matchFailed(swipeCaptcha: SwipeCaptcha)
    }
        ...
        failAnim.apply {
            ...
            addListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    onCaptchaMatchCallback?.matchFailed(this@SwipeCaptcha)
                }
            })
        }
        successAnim.apply {
            ...
            addListener(object : AnimatorListenerAdapter() {
                ...
                override fun onAnimationEnd(animation: Animator) {
                    onCaptchaMatchCallback?.matchSuccess(this@SwipeCaptcha)
