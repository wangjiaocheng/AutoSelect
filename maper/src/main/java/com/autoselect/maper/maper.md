...
---|--------------------------------------------------|---
01 |01. selectMapCustomStyleFile                      |（设置-选项）选择地图自定义风格文件
02 |02. selectTypeMap                                 |（设置-选项）选择地图类型：普通、卫星、夜景、导航、公交
03 |03. selectTypeLocationSpinner                     |（设置-选项）选择定位类型：功能已实现，只需创建选择器
04 |04. selectTypeLanguage                            |（设置-选项）选择语言类型：中文、英文
05 |05. selectPositionLogo                            |（设置-选项）选择logo位置：下左、下中、下右
06 |06. selectPositionControls                        |（设置-选项）选择控件位置：右中、右下
...
16 |16. showUiSettings                                |（设置-开关）地图启用手势控件定位：拖拽、缩放、倾斜、旋转、比例尺、缩放按钮、指南针、定位按钮、室内地图控件
17 |17. showLayers                                    |（设置-开关）地图显示图层：交通、建筑、文字、室内地图
18 |18. mapIndoorFloorSwitchView                      |（开发-创建）自定义室内地图：控件已实现，只需创建其实例
19 |19. showIndoor                                    |（设置-开关）显示自定义室内地图：MapIndoorFloorSwitchView
...
52 |52. listenerEvent                                 |（设置-开关）启用事件监听：加载、移动、点击、长按、触摸、兴趣点点击、Marker拖动、Marker点击、信息窗口点击
