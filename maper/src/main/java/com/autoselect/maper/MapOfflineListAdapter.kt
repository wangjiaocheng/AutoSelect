...
import kotlinx.android.synthetic.main.offline_group.view.*
...
class MapOfflineListAdapter(
    ...
    override fun getGroupView(
        ...
        (convertView ?: RelativeLayout.inflate(context, R.layout.offline_group, null)).apply {
            val groupText: TextView? = group_text
            val groupImage: ImageView? = group_image
