...
object RouteHelper {
    ...
    fun requestCode(requestCode: Int): RouteHelper? = apply { this.requestCode = requestCode }
    private var fromActivity: Activity? = null
    fun newIntent(context: Activity?): RouteHelper? = apply { fromActivity = context }
    private var fromFragment: android.app.Fragment? = null
    fun newIntent(fragment: android.app.Fragment?): RouteHelper? = apply { fromFragment = fragment }
    private var fromFragmentX: Fragment? = null
    fun newIntent(fragment: Fragment?): RouteHelper? = apply { fromFragmentX = fragment }
    private var intent: Intent? = Intent()
    fun addFlags(flags: Int): RouteHelper? = apply { intent?.addFlags(flags) }
    fun putExtraParam(key: String, value: Any?): RouteHelper? =
    ...
    fun to(to: Class<*>?): RouteHelper? = apply { this.to = to }
    private var data: Bundle? = null
    fun putBundle(data: Bundle?): RouteHelper? = apply { this.data = data }
    fun putBundleParam(key: String, value: Any?): RouteHelper? = apply {
    ...
    fun options(options: ActivityOptionsCompat?): RouteHelper? = apply { this.options = options }
    ...
    fun anim(enterAnim: Int, exitAnim: Int): RouteHelper? = apply {
