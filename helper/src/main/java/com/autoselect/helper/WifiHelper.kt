...
object WifiHelper {
    ...
    val wifiInfo: String? = mWifiInfo?.toString() ?: "NULL"//得到WifiInfo所有信息包
    val mac: String = mWifiInfo?.macAddress ?: "NULL"
    val ip: Int = mWifiInfo?.ipAddress ?: 0
    val currentNetId: Int = mWifiInfo?.networkId ?: 0
    ...
    fun checkSSIDState(ssid: String?): Boolean {
        ...
        return if (mWifiInfo != null && ssId != null) ssId == "\"$ssid\"" || ssId == ssid else false
    }//判断某个网络是否连接
