...
object CacheDoubleHelper {
    class CacheDouble private constructor(
        private val cacheMemory: CacheMemoryHelper.CacheMemory,
        private val cacheDisk: CacheDiskHelper.CacheDisk
    ) {
        ...
        companion object {
            ...
            val instance: CacheDouble
                get() = getInstance(
                    CacheMemoryHelper.CacheMemory.instance, CacheDiskHelper.CacheDisk.instance
                )
            private val CACHE_MAP = HashMap<String, CacheDouble>()
            fun getInstance(
                cacheMemory: CacheMemoryHelper.CacheMemory, cacheDisk: CacheDiskHelper.CacheDisk
