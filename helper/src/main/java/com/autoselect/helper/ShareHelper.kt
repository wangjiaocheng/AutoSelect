...
import com.autoselect.helper.UriHelper.file2Uri
import java.io.File
...
object ShareHelper {
    ...
    }.let { ActivityHelper.startActivity(activity, Intent.createChooser(it, "分享到")) }//分享多图片
    ...
    }.let { ActivityHelper.startActivity(activity, Intent.createChooser(it, "分享到")) }//分享多图片到朋友圈
    ...
    fun shareMultiplePictureToWeChatContactsForResult(
        ...
        putParcelableArrayListExtra(Intent.EXTRA_STREAM, getMediaUrisFromPaths(filePaths))
        putExtra("Kdescription", description)
    }.let { ActivityHelper.startActivity(activity, Intent.createChooser(it, "分享到")) }//分享多图片到联系人
    ...
    }.let { ActivityHelper.startActivity(activity, Intent.createChooser(it, "分享到")) }
